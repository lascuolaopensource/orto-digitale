...
export default function Giardino(props: Props) {
	const { className, onAreaClick = () => {}, children } = props
			...
			>
				<g>
					<path
						...
						fill="#8DAC5C"
						onClick={() => onAreaClick(ID.entrata)}
					/>
					<path
					...
					<path
						...
						fill="#9C6E55"
						onClick={() => onAreaClick(ID.compostiera)}
					/>
					<path
						...
						fill="#D3A182"
						onClick={() => onAreaClick(ID.ricettario)}
					/>
					<path
					...
					<path
						...
						fill="#688B3F"
						onClick={() => onAreaClick(ID.percorsoAromatico)}
					/>
					<path
						id={ID.vasche}
					...
					<path
						...
						fill="#649C9E"
						onClick={() => onAreaClick(ID.percorsoAlimurgico)}
					/>
					<path
						id={ID.atelier}
						...
						fill="#D0ABA2"
						onClick={() => onAreaClick(ID.atelier)}
					/>
					<path
						...
						fill="#EECC79"
						onClick={() => onAreaClick(ID.alberiDaFrutto)}
					/>
				</g>
			</svg>
		</div>
